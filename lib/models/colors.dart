...
class AppColor {
  ...
  static Color secondPageContainerGradient1stColor = const Color(0xFF414fc5); //not updated
  static Color secondPageContainerGradient2ndColor = const Color(0xFF4c5fbe); // not updated
